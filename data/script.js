...
async function stats() {
    ...
    const el_dateupdate = document.createElement('div')
    el_dateupdate.innerHTML = `Updated: ${jsonData.dateupdate}`
    el_dateupdate.style.color = `var(--scrollbar-thumb-hover-color)`
    info.appendChild(el_dateupdate)
